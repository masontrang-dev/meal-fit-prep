...
export const storageGuide: StorageRow[] = [
  {
    ...
    window: "3–4 days",
    notes:
      "Eat Mon through Wed. Don't prep more fish than you'll eat by Wednesday — cook Thursday or Friday portions fresh mid-week if needed (15 min). Most time-sensitive protein.",
  },
  {
