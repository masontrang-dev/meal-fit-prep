...
<template>
  <AppPage>
    <div class="max-w-[980px] mx-auto">
      <div class="mb-8">
        <h1 class="font-display text-3xl font-bold text-black mb-4">Prep & Cook Timeline</h1>
        <p class="text-sm text-black leading-relaxed">
          Sunday afternoon · ~90–100 min total · mostly hands-off oven time.
          <strong>Everything for the week is done here</strong> — prep, cooking, and Wednesday's
          cast iron setup.
        </p>
      </div>
      ...
      <div v-if="!cookingMode">
        ...
        <CalloutBox v-if="!randomizerStore.confirmedPlan" variant="gold" class="mb-7">
          <p>
            ...
            Fridge tab, this Prep & Cook timeline will become dynamic and personalized to your
            selected meals.
          </p>
        </CalloutBox>
