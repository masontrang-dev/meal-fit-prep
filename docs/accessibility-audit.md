...
| EmergencyMeals toggle | ✅ | ✅ | ✅ | Native button element |
...
- `aria-expanded`: Collapsible sections (emergency meals)
...
| Emergency meals toggle | Announces "Toggle emergency meals section, button, expanded/collapsed" | ✅ Ready |
...
| Emergency meals toggle | 44px | ✅ PASS |
